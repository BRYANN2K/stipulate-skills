...
- [Hermes Agent skills documentation](https://hermes-agent.nousresearch.com/docs/user-guide/features/skills) — native skill discovery and slash-command behavior. [Hermes Agent hooks documentation](https://hermes-agent.nousresearch.com/docs/user-guide/features/hooks) — `pre_tool_call` JSON protocol, blocking responses, exit-code behavior, and fail-closed shell-hook configuration used by the optional Web Craft adapter.
...
- [coreyhaines31/marketingskills at `7868cb9`](https://github.com/coreyhaines31/marketingskills/tree/7868cb9251fad80a73d26e488a5ad5f6c4a9f335), MIT — product context, copywriting, copy editing, product marketing, conversion, and launch checks. Web Craft independently reorganizes these concerns around a source-backed claims ledger, state microcopy, and a design-before-build gate rather than copying funnel formulas.
