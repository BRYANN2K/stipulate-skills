...
class WebApplicationContractTests(unittest.TestCase):
 ...
 def test_quality_requires_multiple_viewports(self): q=self.data()["quality"]; q["viewports"]=["desktop"]; self.write(quality=q); self.assertNotEqual(self.run_cli().returncode,0)
