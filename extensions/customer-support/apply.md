...
Partir des symptômes, demandes et procédures existantes. Définir diagnostic minimal sans secret, actions récupérables et limites d’autonomie. Rédiger aide et réponses pour les lecteurs concernés ; tester le runbook avec une fixture représentative et vérifier l’escalade. Relier les causes récurrentes au backlog. Ne pas contacter les utilisateurs, promettre un délai ou ouvrir une permanence sans autorisation.
