# frontend-engineering — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les développeurs : composants, états, contrats de données, configuration, commandes de vérification et contraintes de navigateur.
