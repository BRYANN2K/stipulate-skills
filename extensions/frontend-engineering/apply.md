...
Tracer événement utilisateur, état, requête et rendu. Réutiliser composants et conventions ; définir source de vérité, annulation et concurrence des requêtes. Implémenter chargement, vide, erreur, succès et nettoyage des ressources. Vérifier le parcours dans le navigateur avec données et tailles représentatives, puis mesurer les performances contractuelles. Ne pas attribuer au frontend une panne de service sans vérifier la dépendance.
