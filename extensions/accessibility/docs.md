# accessibility — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les développeurs et responsables du service : exigences, environnements, résultats, exceptions, support, déclaration si requise et re-test.
