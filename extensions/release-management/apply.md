...
Identifier version, contenu, consommateurs et compatibilité. Assembler l’artefact traçable, notes et instructions de migration depuis les preuves de check. Vérifier installation ou mise à jour et retour dans les environnements retenus. Préparer la décision de diffusion et les signaux d’arrêt. Publier seulement avec autorisation existante ; archive du changement et release externe restent distincts.
