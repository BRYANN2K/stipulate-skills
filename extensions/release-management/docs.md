# release-management — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour utilisateurs, support et opérateurs : version, changements, compatibilité, installation, migration, problèmes connus et retour.
