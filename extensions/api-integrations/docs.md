# api-integrations — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les intégrateurs et opérateurs : version, exemples anonymisés, authentification, limites, erreurs, rotations et propriétaire de chaque côté.
