# analytics-experimentation — réaliser
...
Établir décision, population, baseline et qualité des données. Fixer métrique primaire, garde-fous, assignation, fenêtre et règle d’arrêt avant exposition. Implémenter et tester événements, consentement et assignation. Analyser selon le plan avec incertitude, SRM, exclusions et segments. Distinguer association et causalité ; ne pas annoncer un effet avant la fenêtre réelle ni déplacer les seuils pour gagner.
