# analytics-experimentation — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour analystes et décideurs : définitions, instrumentation, plan, méthode, consentement, qualité, résultats, incertitude et décision.
