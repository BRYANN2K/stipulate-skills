# ai-engineering — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les mainteneurs et opérateurs : versions, prompts, schémas, evals, seuils, données permises, limites d’autorité, incidents et désactivation.
