...
Tracer modèle, configuration, prompt, contexte, outils et fallback réels. Versionner les cas représentatifs et seuils par classe avant optimisation. Implémenter validation côté application, droits d’outils, budgets, délais et repli. Rejouer succès, ambiguïtés, injections, refus et régressions sur la configuration engagée. Inspecter traces, qualité, latence et coût ; aucune action du modèle ne remplace l’autorisation requise.
