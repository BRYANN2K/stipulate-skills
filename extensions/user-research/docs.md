# user-research — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour l’équipe qui prendra la décision : questions, méthode, recrutement, couverture, synthèse anonymisée, limites, décisions et prochaine question ; conserver les données selon le consentement.
