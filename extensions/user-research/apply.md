...
Turn assumptions into questions that change a decision. Choose methods, participants, consent, and note protection. Prepare and pilot the guide and prototype. Conduct only authorized sessions, separate observations from interpretations, analyze differences and bias, and connect findings to decisions. Do not recruit or contact people without existing authorization.
