# data-engineering — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les producteurs, consommateurs et opérateurs : contrats, lignage, fraîcheur, qualité, droits, backfill, reprise et propriétaires.
