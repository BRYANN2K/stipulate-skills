# devops-delivery — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les développeurs et opérateurs : pipeline, artefacts, environnements, permissions, secrets, gates, récupération et commandes de reproduction.
