# desktop-engineering — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les développeurs et support : plateformes, processus, IPC, fichiers, permissions, diagnostic, build, mise à jour et récupération.
