...
Partir de l’expérience utilisateur et des dépendances pour définir SLI, fenêtre et SLO. Vérifier baseline et qualité des signaux. Implémenter protections, alertes et capacité requises ; exercer une dégradation représentative et la récupération. Vérifier que le runbook conduit à une action. Séparer test ponctuel et disponibilité sur une période réelle ; aucune astreinte ou surveillance n’est créée implicitement.
