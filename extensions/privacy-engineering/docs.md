# privacy-engineering — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les responsables de données et mainteneurs : finalités, flux, décisions applicables, conservation, droits, prestataires, preuves et limites.
