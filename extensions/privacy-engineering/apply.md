...
Cartographier données, finalités, personnes, destinataires, régions et conservation. Vérifier les décisions juridiques applicables auprès des responsables compétents plutôt que les inventer. Réduire les champs, borner accès et logs, implémenter suppression/export ou consentement requis. Tester le cycle complet, copies et sous-traitants inclus dans le contrat. Utiliser des données anonymisées ; ne pas présenter une checklist comme certification juridique.
