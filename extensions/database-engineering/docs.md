# database-engineering — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les développeurs et opérateurs : modèle, invariants, migrations, fenêtres de compatibilité, indexes, sauvegarde, restauration et limites de volume.
