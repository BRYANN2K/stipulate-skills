...
Inventorier schéma actif, volume, indexes, transactions et consommateurs. Préparer une migration progressive compatible avec les versions retenues, avec sauvegarde et retour ou récupération définis. Tester sur une copie représentative anonymisée : intégrité, concurrence, verrouillage, plans et coût. Rejouer migration et restauration selon le contrat. Séparer succès du script, état actif et preuve d’absence de perte.
