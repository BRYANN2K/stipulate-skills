# content-design — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les rédacteurs, support et développeurs : termes, textes sources, règles de contenu, localisation, preuves de compréhension, propriétaire et échéance.
