...
Tracer entrée, validation, autorisation, transaction et effets externes. Définir invariants, erreurs et frontières transactionnelles. Implémenter concurrence, idempotence, annulation ou reprise nécessaires avec dépendances explicites. Exercer le chemin réel et les échecs, contrôler l’observabilité sans secrets, puis documenter récupération et limites. Éviter une réécriture d’architecture non requise par le contrat.
