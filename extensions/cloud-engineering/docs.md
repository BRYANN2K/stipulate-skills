# cloud-engineering — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les opérateurs et responsables de coût : architecture, propriétaire, régions, accès, quotas, budget, alertes, restauration et retrait.
