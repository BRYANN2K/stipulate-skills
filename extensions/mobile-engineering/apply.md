...
Établir plateformes, versions, appareils, permissions et chemins natifs. Implémenter transitions de cycle de vie, état persistant, réseau dégradé et refus de permission selon le contrat. Vérifier interruption, reprise, rotation ou tailles utiles, accessibilité et consommation. Exécuter sur appareils ou simulateurs identifiés ; distinguer leurs limites. Préparer signature et distribution seulement dans le périmètre autorisé.
