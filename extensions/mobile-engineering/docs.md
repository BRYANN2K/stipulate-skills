# mobile-engineering — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les développeurs, QA et release : matrice d’appareils, permissions, cycle de vie, hors ligne, build, signature et contraintes de distribution.
