# mobile-engineering — docs

This reference contributes to **stip-docs**; it neither replaces core documentation nor creates an independent phase.

For developers, QA, and release teams: device matrix, permissions, lifecycle, offline behavior, builds, signing, and distribution constraints.
