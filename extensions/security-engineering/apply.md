...
Identifier actifs, acteurs, frontières et abus réalistes dans le périmètre. Tracer les contrôles réellement exécutés ; implémenter validation, autorisation, gestion de secrets et protections proportionnées. Tester chemins autorisés et refusés, erreurs et régressions sur des fixtures autorisées. Relier chaque finding à une preuve et au contrôle corrigé. Ne pas étendre un audit ni lancer des tests externes intrusifs sans autorisation.
