# product-strategy — documenter

Cette référence contribue à **spec-docs** ; elle ne remplace pas la documentation du cœur ni ne crée une phase indépendante.

Pour les décideurs et l’équipe produit : problème, publics, alternatives, arbitrages, hypothèses, indicateurs, limites et déclencheur de révision.
