---
name: spec-bootstrap
description: Adopt the spec workflow in a new or existing repository, preserving project conventions and assessing applicable domains.
license: Apache-2.0
metadata:
  version: "2.0.0"
  author: BRYANN2K
...
4. Review existing AGENTS.md rather than replacing it. Resolve contradictions explicitly. Set available extension paths in config only when the extension exists and its selection is justified. No domain extensions ship in core v1.
5. Report what was created, preserved, inferred and still unknown. Subsequent feature work starts at spec-explore; rerunning bootstrap preserves current changes and project notes.

Do not create an empty example feature. The first real spec-explore creates its own folder. Do not claim a project is production-ready merely because bootstrap succeeded.
