...
2. Run `python3 <this-skill-directory>/scripts/setup_stip.py --root <physical-project-root>`. This prepares the workflow, appends one bounded block to AGENTS.md, and copies all bundled domain packages into the project as available extensions. It does not initialize Git, choose a stack, certify maturity, or select extensions for any change.
