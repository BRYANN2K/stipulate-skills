...
Map actual sources, builds, tests, artifacts, promotion, and environments. Define least-privilege identities, secrets, and useful gates. Build reproducible jobs, promote the same artifact, and record provenance. Test failure, recovery, and rollback in an authorized environment. Distinguish a green pipeline, an available artifact, and deployed behavior; do not deploy implicitly.
