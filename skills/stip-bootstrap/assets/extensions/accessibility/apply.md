...
Define applicable surfaces, tasks, level, and environments. Prefer native semantics; implement names, roles, states, focus, keyboard behavior, and alternatives. Incrementally verify automation, keyboard access, zoom, contrast, and selected assistive technologies. Correct observed blockers and involve people or auditors required by the contract. Do not infer overall conformance from an automated scan.
