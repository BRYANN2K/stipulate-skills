...
Identify in-scope assets, actors, boundaries, and realistic abuse. Trace controls actually executed; implement proportionate validation, authorization, secret handling, and protections. Test allowed and denied paths, errors, and regressions on authorized fixtures. Link every finding to evidence and the corrected control. Do not expand an audit or run intrusive external tests without authorization.
