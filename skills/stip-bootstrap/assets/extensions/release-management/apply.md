...
Identify the version, contents, consumers, and compatibility. Assemble the traceable artifact, notes, and migration instructions from check evidence. Verify installation or upgrade and rollback in selected environments. Prepare the distribution decision and stop signals. Publish only with existing authorization; change archive and external release remain distinct.
