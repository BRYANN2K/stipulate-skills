# analytics-experimentation — docs

This reference contributes to **stip-docs**; it neither replaces core documentation nor creates an independent phase.

For analysts and decision-makers: definitions, instrumentation, plans, methods, consent, quality, results, uncertainty, and decisions.
