# analytics-experimentation — apply
...
Establish the decision, population, baseline, and data quality. Fix the primary metric, guardrails, assignment, window, and stopping rule before exposure. Implement and test events, consent, and assignment. Analyze according to plan, including uncertainty, SRM, exclusions, and segments. Distinguish association from causation; do not announce effects before the actual window ends or move thresholds to win.
